...
public class BlueprintsServices {
    ...
    public void filtrarRedundancias(Blueprint bp) {
        filtro.filtradoDeRedundancias(bp);
    }

    public void filtrarSubmuestreo(Blueprint bp) {
        filtro.filtradoDeSubmuestreo(bp);
    }
}
